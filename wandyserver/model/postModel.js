...
class Post {
    ...
    createNewPost(newPost, result){
        ...
        const values = [newPost.title, newPost.description, newPost.tag, date, date, newPost.image]
        const sqlStatement = 'INSERT INTO posts (title, description, tag, createdAt, updatedAt, image) VALUES(?)'
    ...
    updatePost(newPost, id, result) {
        ...
        const values = [newPost.title, newPost.description, newPost.tag, crtDate, updDate, newPost.image, parseInt(id)]
    ...
    updatePostNoImg(newPost, id, result) {
        const crtDate = new Date(newPost.createdAt)
        const updDate = new Date(newPost.updatedAt)
        const values = [newPost.title, newPost.description, newPost.tag, crtDate, updDate, parseInt(id)]
